...
| 07   | d5557b75-ff80-4aab-86a6-9b1a522bbbce                         | 会话 ID                                                      |
| 08   | user11                                                       | 客户端 C 端用户注册后产生的 ID，即用户 ID                    |
| 09   | BIZ_APM                                                      | BIZ_FRAME 为启动卡死，BIZ_APM 为 ANR 卡死                    |
| 10   | APM_ANR                                                      | FRAME_CLIENT_STARTUP_DEAD 为启动卡死，APM_ANR 为 ANR 卡死    |
| 11   | 1000                                                         | 1111 为启动卡死，1114 为 iOS ANR 卡死，1000 为 Android ANR卡死 |
| 12   | historyStacks=xxx                                            | 具体错误堆栈                                                 |
| 13   | 1                                                            | 操作系统类别    1代表安卓，2代表IOS，3代表全平台             |
| 14   | 4.4.2                                                        | ANR 卡死时为操作系统版本                                     |
| 15   | WIFI                                                         | 网络类型，如： WIFI、2G、3G、4G                              |
| 16   | vivo Xplay3S                                                 | ANR 卡死时为设备型号                                         |
| 17   | goose                                                        | 渠道号                                                       |
| 18   | Wn1111111111111111111QxL                                     | 设备 ID                                                      |
| 19   | zh-CN                                                        | 操作系统语言                                                 |
| 20   | 4                                                            | CPU 核数                                                     |
